...
const Cell = (props) => {
  ...
  return (isActive ? <div onClick={handleClick} className = "cell active" style={{backgroundColor: color}}></div> : <div className='cell' style={{backgroundColor: color}} onClick={handleClick}></div>)
}
